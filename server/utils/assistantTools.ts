  ...
  return [
    ...
    },
    {
      ...
      function: {
        ...
        description:
          'Load the full Help Center article by slug (body_md included). Use after resolve_help. POS+CRM+SKUMS setup / live loyalty: slug **crm-pos-skums-setup**. PO/transfer statuses: **po-transfer-lifecycle**. Also store-ops-*, operator-runbook, actions-inbox, inbound ASN. Prefer this over guessing.',
        parameters: {
          type: 'object',
          properties: {
            slug: {
