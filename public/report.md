...
```mermaid
flowchart LR
  A["Attach Wall<br/>&lt;S$10 · patches, single masks,<br/>mists, hand/foot masks"] -->|"any 3 = S$12 tier"| B["Routine Builder<br/>pick 3 / pick 5 across<br/>step zones, cross-brand"]
  B -->|"pick 3 ≈ 10% value<br/>pick 5 ≈ 18% value"| C["Story Sets<br/>curated cross-brand<br/>ingredient routines"]
  C -->|"named sets, seasonal rotation"| D["Basket ≥ 3.5 items<br/>heroes never discounted"]
  A -->|register / queue placement| D
```
