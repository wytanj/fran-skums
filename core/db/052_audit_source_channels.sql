-- ============================================================
-- Audit source channels (M1)
--
-- Purpose:
--   Distinguish UI / MCP / API / assistant / cron / worker writes
--   from unattributed db_trigger rows.
--
-- Run AFTER: 029_audit_events.sql
-- ============================================================

-- Drop existing check (default PG name for column check)
